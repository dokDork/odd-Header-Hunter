...
cat "$myPath/$domains_file" | assetfinder --subs-only | anew "$myPath/appo/domains-not-trusted.txt"
...
findomain -f "$myPath/$domains_file" | anew "$myPath/appo/domains-not-trusted.txt"
